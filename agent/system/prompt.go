...
func (a *Agent) Prompt(ctx context.Context, req agent.PromptRequest, w io.Writer) error {
	return a.PromptStream(ctx, req, func(ev agent.PromptEvent) {
...
func (a *Agent) PromptStream(ctx context.Context, req agent.PromptRequest, cb func(agent.PromptEvent)) error {
	if a.addr == "" {
...
func (a *Agent) PromptObject(ctx context.Context, req agent.ObjectPromptRequest) ([]byte, error) {
	if a.addr == "" {
